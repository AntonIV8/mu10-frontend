    ...
    sitemap: Ember.computed('i18n.locale', function () {
      ...
      return {
        nodes: [{
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu10.caption'),
          title: i18n.t('forms.application.sitemap.mu10.title'),
          children: [{
            link: 'i-i-s-mu10-s33-l',
            caption: i18n.t('forms.application.sitemap.mu10.i-i-s-mu10-s33-l.caption'),
            title: i18n.t('forms.application.sitemap.mu10.i-i-s-mu10-s33-l.title'),
            children: null
          }]
        }]
      };
...
define('ember-app/controllers/i-i-s-mu10-s33-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-mu10-s33-l'
  });
});
define('ember-app/controllers/i-i-s-mu10-s33-e/new', ['exports', 'ember-app/controllers/i-i-s-mu10-s33-e'], function (exports, _iISMu10S33E) {
  'use strict';
  ...
  var IISmu10S33ENewController = _iISMu10S33E.default;
  exports.default = IISmu10S33ENewController;
});
define('ember-app/controllers/i-i-s-mu10-s33-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-mu10-s33-e'
     */
    editFormRoute: 'i-i-s-mu10-s33-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-mu10-s33-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-mu10-s33-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/en/models/i-i-s-mu10-s33", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-mu10-s33-l', 'ember-app/locales/en/forms/i-i-s-mu10-s33-e', 'ember-app/locales/en/models/i-i-s-mu10-s33'], function (exports, _translations, _iISMu10S33L, _iISMu10S33E, _iISMu10S) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-mu10-s33': _iISMu10S.default
    },
    ...
    forms: {
      ...
      application: {
        ...
        sitemap: {
          ...
          mu10: {
            ...
            title: 'mu10',
            'i-i-s-mu10-s33-l': {
              caption: 'i-i-s-mu10-s33-l',
              title: 'i-i-s-mu10-s33-l'
            }
          }
        }
      },
      ...
      'i-i-s-mu10-s33-l': _iISMu10S33L.default,
      'i-i-s-mu10-s33-e': _iISMu10S33E.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-mu10-s33-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-mu10-s33-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/ru/models/i-i-s-mu10-s33", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-mu10-s33-l', 'ember-app/locales/ru/forms/i-i-s-mu10-s33-e', 'ember-app/locales/ru/models/i-i-s-mu10-s33'], function (exports, _translations, _iISMu10S33L, _iISMu10S33E, _iISMu10S) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-mu10-s33', ['exports', 'ember-flexberry-data/utils/attributes'], function (exports, _attributes) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-mu10-s33-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-mu10-s33', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-mu10-s33', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-mu10-s33'], function (exports, _emberCpValidations, _model, _offlineModel, _iISMu10S) {
  'use strict';
  ...
  const Validations = (0, _emberCpValidations.buildValidations)(_iISMu10S.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  let Model = _model.default.extend(_offlineModel.default, _iISMu10S.Model, Validations, {});

  (0, _iISMu10S.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-mu10-s33-e', { path: 'i-i-s-mu10-s33-e/:id' });
    this.route('i-i-s-mu10-s33-e.new', { path: 'i-i-s-mu10-s33-e/new' });
  });
...
define('ember-app/routes/i-i-s-mu10-s33-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    modelProjection: 'S33E',
    modelName: 'i-i-s-mu10-s33'
  });
});
define('ember-app/routes/i-i-s-mu10-s33-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'S33E',
    modelName: 'i-i-s-mu10-s33',
    templateName: 'i-i-s-mu10-s33-e'
  });
});
define('ember-app/routes/i-i-s-mu10-s33-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @default 'S33L'
    */
    modelProjection: 'S33L',

    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-mu10-s33'
    */
    modelName: 'i-i-s-mu10-s33',
...
define('ember-app/serializers/i-i-s-mu10-s33-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu10-s33-offline', 'ember-app/serializers/application-offline'], function (exports, _iISMu10S33Offline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISMu10S33Offline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-mu10-s33', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu10-s33', 'ember-app/serializers/application'], function (exports, _iISMu10S, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISMu10S.Serializer, {
    /**
